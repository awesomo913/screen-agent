"""toolkit_116_aws_tools.py
AWS SDK helpers — S3 upload/download, EC2 list, Lambda invoke via boto3.
"""
import subprocess, os, sys, json, re
from pathlib import Path

def check_available() -> dict:
    """Check if dependencies for aws are available."""
    import importlib
...
def get_info() -> dict:
    ...
    return {"success": True, "data": {"module": "toolkit_116_aws_tools", "description": "AWS SDK helpers — S3 upload/download, EC2 list, Lambda invoke via boto3."}, "error": None}
